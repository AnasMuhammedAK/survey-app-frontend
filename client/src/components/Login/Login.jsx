...
import { loginUserAction } from "../../Redux/SlicesAndServices/user/usersSlice";
  ...
  return (
    <>
      <section className="min-h-screen relative py-20 2xl:py-40 bg-slate-100 overflow-hidden">
        <div className="absolute top-0 left-0 lg:bottom-0 h-full lg:h-auto w-full lg:w-4/12 bg-[#DEF7E5] lg:overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-wrap items-center -mx-4">
              <div className="w-full lg:w-2/5 px-4">
                <div className="px-6 lg:px-12 py-12 lg:py-24 bg-white shadow-lg rounded-2xl">
                  {/* Form */}
                  <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className="flex items-center pl-6 mb-6 border border-gray-200 bg-white rounded-full">
                      <span className="inline-block pr-3 border-r border-gray-100">
                        <svg
                          className="w-5 h-5"
                          width="20"
