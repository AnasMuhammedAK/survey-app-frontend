...
const navigation = [
  ...
  { name: "Questions List", href: "/questions", current: false },
  { name: "Survey Analytics ", href: "/surveys", current: false },
];
...
const dispatch = useDispatch()
  ...
  return (
    <Disclosure as="nav" className="bg-black fixed top-0 left-0 right-0 z-10 py-3">
      {({ open }) => (
        <>
          <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
                  ...
                  {navigation.map(item => (
                    <Link
                      ...
                      className={classNames(
                        ...
                        "px-3 py-2 rounded-md text-sm xl:text-xl font-medium"
                      )}
              ...
              <button
                ...
                <div className="hidden ml-2  md:flex-shrink-0 md:flex md:items-center">
                  {/* Profile dropdown */}
                ...
                <p className="text-white text-xl ml-2">Admin</p>
              </div>
            </div>
          </div>
